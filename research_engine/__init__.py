...
# lanes count as covered only when candidates pass relevance, access-depth,
# source-role qualification and proposition support where empirical testing is
# claimed. Weak candidates remain visible but can only downgrade/block COMPLETE.
