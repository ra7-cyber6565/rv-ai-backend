...
def _cannot_test(experiments: Sequence[Mapping[str, Any]]) -> list:
    ...
    if not any(e.get("Dataset/sample") != UNKNOWN for e in experiments):
        rows.append("Effect size/CI/power/bootstrap/permutation/replication require a concrete dataset/sample.")
    if not any(e.get("test_state") in {TEST_PERFORMED, RESULT_OBSERVED} for e in experiments):
...
class AI2ValidationDirector:
    def build_packet(
        self,
        question: str,
        research_result: Optional[Mapping[str, Any]],
        ...
        second = second_pass_summary(second_pass_outputs)
        ...
        experiment_section: Dict[str, Any] = {
            ...
            "statistical_validation_standard": [
                ...
                "Bayesian evidence with explicit priors/likelihoods", "bootstrap",
                "permutation test", "Monte Carlo", "multiple-testing correction", "power analysis",
            ],
        ...
        sections: Dict[str, Any] = {
            ...
            "2. Quantifiable Components": {
                "variables_by_hypothesis": [{"hypothesis_id": e["hypothesis_id"], "variables": e["Variables"]} for e in experiments],
            ...
            "4. Baselines": {
                "policy": "Every complex candidate must beat the simplest valid baseline under the same data, metric and friction assumptions.",
            ...
            "7. Bias & Leakage Risks": bias_audit(result),
            "8. Robustness Plan": robustness_plan(),
            "9. Ablation Plan": ablation_plan(hypotheses),
            "10. Real-World Friction": friction_plan(trading),
            "11. Failure Modes": failure_plan(),
            ...
            "17. Exactly What Prevents a Higher Score": _blockers(experiments, confidence, trading),
        }
        packet: Dict[str, Any] = {
            ...
            "input_summary": {
                ...
                "second_pass_inputs_present": bool(second_pass_outputs),
