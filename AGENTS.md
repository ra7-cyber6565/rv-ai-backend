...
If PR #81 / branch `fix/live-trading-acceptance-20260908` is open or is the work being continued, also read **`PR81_HANDOFF.md`** before editing or merging. It records the measured trading defects, the exact-head/live acceptance boundary, and why generic superconductivity live receipts do not prove the PR #81 repairs.
...
- PR #79 is merged; do not treat its old branch as the current broad completion vehicle. Follow the newest authority recorded in `AI_HANDOFF.md`, any active repair handoff such as `PR81_HANDOFF.md`, plus the current `main` SHA.
- Do not restart or duplicate features already listed as implemented in `AI_HANDOFF.md`, `MAX_MODE_CONTRACT.md`, `PR81_HANDOFF.md` when applicable, and `docs/INFINITY_REQUIREMENT_LEDGER.md`.
...
1. `AI_HANDOFF.md`
2. `PR81_HANDOFF.md` when PR #81 / its branch is active
3. `MAX_MODE_CONTRACT.md` when research modes/orchestration are involved
4. current continuation at the top of `WORK_STATUS.md`
5. `docs/INFINITY_REQUIREMENT_LEDGER.md`
6. current `main` SHA, relevant PR/branch, and exact-head CI
7. relevant runtime/validation docs named in `AI_HANDOFF.md`
